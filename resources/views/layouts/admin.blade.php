...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('Noticia.create')}}" class="nav-link">Crear Noticias</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('Experiencia.index')}}" class="nav-link">Mas sobre Docentes</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('Admin.index')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Usuario {{$name}}</span>
    </a>
